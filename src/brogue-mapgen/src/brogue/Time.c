...
static void playerFalls() {
    ...
    /* Presentation adapters need the source hole before startLevel() replaces
     * pmap and relocates the player. This observation does not alter Brogue's
     * fall resolution or RNG. */
    brogue_bridge_note_player_fall(player.loc);
