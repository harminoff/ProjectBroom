...
CATEGORIES = (
    ...
    Category("POTION", 8, ("life", "strength", "telepathy", "levitation", "detect magic", "haste", "fire immunity", "invisibility", "poison", "paralysis", "hallucination", "confusion", "incineration", "darkness", "descent", "lichen"), "glass", True),
    Category("SCROLL", 16, ("enchanting", "identify", "teleportation", "remove curse", "recharging", "protect armor", "protect weapon", "sanctuary", "magic mapping", "negation", "shattering", "discord", "aggravate monster", "summon monster"), "paper", True),
    ...
    Category("WAND", 64, ("teleportation", "slowing", "polymorph", "negation", "domination", "beckoning", "plenty", "invisibility", "empowerment"), "wood", True),
...
def build_model(category: Category, kind: int | None) -> Mesh:
...
def main() -> None:
    ...
    for category in CATEGORIES:
        ...
        for kind in variants:
            ...
            build_model(category, kind).write(MODEL_DIR / filename)
    ...
    registry = {
        ...
        "atlas": "mod/BrogueDoom/graphics/BRGITEMS.png",
        "items": records,
    }
