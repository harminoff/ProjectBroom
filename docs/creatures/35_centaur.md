...
- Recipe: `centaur`.
- Authored silhouette dimensions: 58 / 42 / 78 map units. Clearance: 0 units.
- Numerical size and details not explicitly stated by Brogue are artistic interpretation, not new game facts.
- Visual construction cues: horse, bow, quiver.
- [Runtime model](../../mod/BrogueDoom/models/monsters/35_centaur.obj).
- [Editable Blender source](../../assets/monsters/sources/35_centaur.blend).
