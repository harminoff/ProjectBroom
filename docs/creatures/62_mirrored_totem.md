...
- Recipe: `prism`.
- Authored silhouette dimensions: 24 / 24 / 46 map units. Clearance: 0 units.
- Numerical size and details not explicitly stated by Brogue are artistic interpretation, not new game facts.
- Visual construction cues: mirror, prism.
- [Runtime model](../../mod/BrogueDoom/models/monsters/62_mirrored_totem.obj).
- [Editable Blender source](../../assets/monsters/sources/62_mirrored_totem.blend).
